...
//Objeto
const peopleAccount10: PeopleAccount = new PeopleAccount (1, "Pedro Lucas" , 10)
console.log (peopleAccount10)
peopleAccount10.setName("Guilherme Rezende") // atribuido um novo valor no objeto usando set na classe pai abstrata
console.log (peopleAccount10)
/*
